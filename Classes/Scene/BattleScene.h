...
public:
	static cocos2d::Scene* createScene(PreloadBattleScene* preloaderScene);
	virtual bool init(PreloadBattleScene* preloaderScene);
	virtual void onEnter();
	virtual void onExit();
	static BattleScene* create(PreloadBattleScene* preloaderScene);
